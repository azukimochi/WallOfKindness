...
class Search extends Component {
  ...
  removeUnwantedGifts = (giftArray, resultsArray) => {
    ...
    if (numOfLoops === giftArray.length) {
      this.setState({ results: cleanedAllGiftsArr }, () => this.getAddresses());
    }
  };
    ...
    return (
      <div>
        <Wrapper>
          ...
          this.state.resultsNotFound === false ? (
            <div className="welcomeDiv">
              <h1 className="welcomeBanner">Welcome!</h1>
              <p id="welcomeNote">
                Feel free to search our archive of gifts from our donors. The
                searches are based on your current location only. If you like
                what you see, you can request it from an angel and organize a
                time to pick the item up!
              </p>
            </div>
          ) : null}
